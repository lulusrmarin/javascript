            ...
            <div v-if="hasFiles">                    
                 <div v-for="(info, filename) in node[ dir ].files" v-if="hasFiles">
                     <div class="inl" :style="{'padding-left': indent}">
                         <i class="fa fa-pencil text-warning pointer tt" aria-hidden="true" @click="share.loadFile( info.path )" title="edit"></i>'
                         <i class="fa fa-trash text-danger pointer tt" aria-hidden="true" @click="deleteFile( info.path )" title="delete"></i>
                         {{filename}}
                     </div>
                 </div>
             </div>
